...
<?php
	...
	$kpipre="";
	error_reporting(0);
	$predict = array(0,$_POST['predict1'],$_POST['predict2'],$_POST['predict3'],$_POST['predict4'],$_POST['predict5'],$_POST['predict6'],$_POST['predict7'],$_POST['predict8'],$_POST['predict9'],$_POST['predict10'],$_POST['predict11'],$_POST['predict12'],$_POST['predict13'],$_POST['predict14'],$_POST['predict15'],$_POST['predict16'],$_POST['predict17'],$_POST['predict18'],$_POST['predict19'],$_POST['predict20'],$_POST['predict21'],$_POST['predict22'],$_POST['predict23'],$_POST['predict24'],$_POST['predict25'],$_POST['predict26'],$_POST['predict27'],$_POST['predict28'],$_POST['predict29'],$_POST['predict30']);
