...
(function(A,w){
	...
	function oa(a){
		...
		if(!(a.liveFired===this||!i||!i.live||a.button&&a.type==="click")){
			a.liveFired=this;var u=i.live.slice(0);
	...
	var c=function(a,b){return new c.fn.init(a,b)},Ra=A.jQuery,Sa=A.$,s=A.document,T,Ta=/^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/,
		  Ua=/^.[^:#\[\.,]*$/,Va=/\S/,Wa=/^(\s|\u00A0)+|(\s|\u00A0)+$/g,Xa=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,P=navigator.userAgent,
		  xa=false,Q=[],L,$=Object.prototype.toString,aa=Object.prototype.hasOwnProperty,ba=Array.prototype.push,
	...
	c.fn=c.prototype={
					...
					if(d[1]){
						...
						if(a=Xa.exec(a))
							if(c.isPlainObject(b)){
								...
								a=[f.createElement(a[1])];//end if(c.isPlainObject(b))
						else{
							a=sa([d[1]],[f]);
		...
		selector:"",jquery:"1.4.2",length:0,size:function(){return this.length},toArray:function(){return R.call(this,0)},
		...
		slice:function(){return this.pushStack(R.apply(this,arguments),"slice",R.call(arguments).join(","))},//end slice
		...
		if(typeof a!=="object"&&!c.isFunction(a))
			...
			for(;b<d;b++)
				if((e=arguments[b])!=null)
					...
					return a
	};//end c.extend=c.fn.extend=function
	c.extend({
		...
		map:function(a,b,d){for(var f=[],e,j=0,i=a.length;j<i;j++){e=b(a[j],j,d);if(e!=null)f[f.length]=e}return f.concat.apply([],f)},guid:1,proxy:function(a,b,d){if(arguments.length===2)if(typeof b==="string"){d=a;a=d[b];b=w}else if(b&&
