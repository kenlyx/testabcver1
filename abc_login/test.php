...
function adminlogin(xml){
	...
	$("message",xml).each(function(id){
		...
		var pass = $("adminpass",message).text();	
		var loginpos = $("adminposi",message).text();	
		
		if(pass=='ok')
		{
			if(loginpos=='teacher'){
			document.location="T_teacherlogin.php";		
			}
			
			else if(loginpos=='stuManager'){
				
			document.location="SL_student_selectgame.php";
			}
...
function checkCID(id){
	...
	xmlhttp.onreadystatechange=function(){
    	...
    	document.getElementById('check0').innerHTML=xmlhttp.responseText;
    	}
    }	
	xmlhttp.open("GET","loginDB.php?cid="+id,true);
	xmlhttp.send();	
}*/
...
<!--login form -->
<div id="loginForm" style="position:fixed; top:350px; right:200px; font-size: 19px;" >
<form name="loginForm" method="post" action="loginDB.php" ><strong>
  帳號: <input type="text" name="adminID" style="font-size:13px"/><br/><br/>
  密碼: <input type="password" name="adminPW" style="font-size:13px"/><br/><br/></strong>
       <tr height="60">
   <td colspan="2" align="center">
      &nbsp;&nbsp;&nbsp;<span><a id="ceo_regi" href="#regiForm" title="註冊"> <img src="./images/signup.png"/></a></span>
      &nbsp;&nbsp;
      <input type="image" src="./images/login.png" href="#" id="loginsubmit" onclick="logincheck(this)"></input>
      </td>
   </tr>
...
<!--register form-->
<div id="regiForm" style=" color:#000; width:780px; height:600px; overflow:auto; padding:-23px;" >

<form name="regForm" method="post" action="loginDB.php" >
<div id="tableWrapper" style="width: 100%;">
<table id="vsTable" style="height:95%; width:90%; float:center; margin-top:2%">
<tbody>
<tr>
...
<tr>
   ...
   <td style="border-right: 5px solid #9e9e9e;">公司人數：<span id="ccount"></span></td>
</tr>

<tr class="second">
   <td class="left" style="text-align:right"><span id="check1">*&nbsp;&nbsp;&nbsp;</span></td>
   <td><span id="Member1" style="text-align:center"/></span></td>
   <td style="border-right: 5px solid #9e9e9e;"> 帳號： <input type="text" size="12px" id="acc1" name="acc1" readonly/></td>
</tr>
...
<tr class="second">
   ...
   <td style="border-right: 5px solid #9e9e9e;"> 帳號： <input type="text" size="12px" id="acc2" name="acc2" readonly/></td>
</tr>
<tr class="second">
   <td class="left" style="text-align:right"><span id="checkcname">*&nbsp;&nbsp;&nbsp;</span></td>
   <td><span id="Member3" style="text-align:center"/></span></td>
   <td style="border-right: 5px solid #9e9e9e;"> 帳號： <input type="text" size="12px" id="acc3" name="acc3" readonly/></td>
</tr>
<tr class="second">
   ...
   <td style="border-right: 5px solid #9e9e9e;"> 帳號： <input type="text" size="12px" id="acc4" name="acc4" readonly/></td>
</tr>
<tr class="second">
   ...
   <td style="border-right: 5px solid #9e9e9e;"> 帳號： <input type="text" size="12px" id="acc5" name="acc5" readonly/></td>
</tr>
...
<tr class="second">
   ...
   <td style="border-right: 5px solid #9e9e9e;"> 帳號： <input type="text" size="12px" id="acc6" name="acc6" readonly/></td>
</tr>

<tr class="second">
    <td class="left" style="text-align:right; border-bottom: 5px solid #9e9e9e;"><span id="checkPwd">*&nbsp;&nbsp;&nbsp;</span></td>
    <td style="	border-bottom: 5px solid #9e9e9e;">
    	<span id="Member7" style="text-align:center"/></span></td>
    <td style="	border-bottom: 5px solid #9e9e9e; border-right: 5px solid #9e9e9e;"> 
