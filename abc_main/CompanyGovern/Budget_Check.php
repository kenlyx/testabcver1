...
<body>
	<div id="content">
        ...
        * 檢視每年預算達成率 *</font></h1>
        <div align="center">
            <input id="finance" type="image" src="../images/sell.png" id="finance" value="財務部門" />
            <input type="image" src="../images/right.png" />
            <input id="produce" type="image" src="../images/produce2.png" id="produce" value="生產部門" />
            <input type="image" src="../images/right.png" />
            <input id="purchase" type="image" src="../images/purchase2.png" id="purchase" value="採購部門" />
            <input type="image" src="../images/right.png" />
            <input type="image" src="../images/human2.png" id="human" value="人力部門" />
            <input type="image" src="../images/right.png" />
            <input id="admin" type="image" src="../images/admin2.png" id="admin" value="行政部門" />
        </div>
        <p>
       <table align="center" border="0">
            <iframe id="frame" width="98%" height="90%" marginwidth="0" marginheight="0" frameborder="0" src='./Budget_Check_finance.php'></iframe>	
       </table>
    </div><!-- end content -->
</body>
<script type="text/javascript">
	$(document).ready(function(){
        $('#finance').click(function() {
            document.getElementById("frame").src='./Budget_Check_finance.php';
		...
		$('#produce').click(function() {
            document.getElementById("frame").src='./Budget_Check_produce.php';
		...
		$('#purchase').click(function() {
            document.getElementById("frame").src='./Budget_Check_purchase.php';
			document.getElementById("finance").src='../images/sell2.png';
			document.getElementById("produce").src='../images/produce2.png';
		...
		$('#human').click(function() {
			document.getElementById("frame").src='./Budget_Check_human.php';
			document.getElementById("finance").src='../images/sell2.png';
			document.getElementById("produce").src='../images/produce2.png';
			document.getElementById("purchase").src='../images/purchase2.png';
		...
		$('#admin').click(function() {
            document.getElementById("frame").src='./Budget_Check_admin.php';
			document.getElementById("finance").src='../images/sell2.png';
			document.getElementById("produce").src='../images/produce2.png';
			document.getElementById("purchase").src='../images/purchase2.png';
			document.getElementById("human").src='../images/human2.png';
